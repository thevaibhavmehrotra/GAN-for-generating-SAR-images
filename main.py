...
Flags.DEFINE_string('summary_dir', './experiment_SRResnet/log/', 'The dirctory to output the summary')
...
Flags.DEFINE_string('task', 'SRResnet', 'The task: SRGAN, SRResnet')
...
Flags.DEFINE_string('input_dir_LR', './data/test_LR/', 'Input Directory of LR Image')
Flags.DEFINE_string('input_dir_HR', './data/test_HR/', 'Input Dir of HR image')
...
Flags.DEFINE_integer('image_queue_capacity', 4096, 'The capacity of the image queue (suggest large to ensure'
                                                   'enough random shuffle')
Flags.DEFINE_integer('queue_thread', 4, 'The threads of the queue (More threads can speedup the training process.')
...
Flags.DEFINE_integer('decay_step', 400000, 'The steps needed to decay the learning rate')
